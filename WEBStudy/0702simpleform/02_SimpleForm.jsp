...
<body>
	<form method="get" action="02_SimpleFormProcess.jsp">
		...
		직업	: <select id = "occupation" name="occupation">
						<option value ="programer"> programmer
						<option value = "web designer"> web designer
						<option value = "white hand"> white hand
