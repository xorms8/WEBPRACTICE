   ...
   <section id = "container">
    <div id="video">
     ...
     <!-- Start Our Team Area -->
                    ...
                    <div class="team__wrap clearfix mt--60">
                        ...
                        <div class="col-md-4 col-lg-4 hidden-sm col-xs-12 xmt-30">
                            <div class="team foo">
                                ...
                                <div class="team__hover__info">
                                    <div class="team__hover__action">
                                        <h2>F2T의 향기와 패키지는 <br /> 특정 성별을 타깃으로 디자인되지 않았습니다.</h2>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="htc__testimonial__area ptb--120" style="background: #000 url(images/bg/4.jpg) no-repeat scroll center center / cover ;" data--black__overlay="6">
            <div class="container">
                <div class="row">
                        ...
                        <div class="testimonial__wrap owl-carousel owl-theme clearfix">
                            ...
                            <div class="testimonial">
                                ...
                                <div class="testimonial__details">
                                      <p style="font-size:32px;">Find Your Signature</p>
        ...
        <!-- Start brand Area -->
        <div class="htc__brand__area bg__white ptb--120" style="background-color:black;">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                       <h2 class="title__line" style = "color:white; text-align:center; margin-bottom:15px">Instagram @F2T</h2>
