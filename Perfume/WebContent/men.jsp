	...
	<div class="container-fluid text-center">
		<div class="row content">
			...
			<div class="col-sm-10 text-left">
				<h1 style="text-align: center;">The Most attractive perfumes for men.</h1>
				<p></p>
				<div id="myCarousel" class="carousel slide" data-ride="carousel">
					<!-- Indicators -->
					<ol class="carousel-indicators">
						<li data-target="#myCarousel" data-slide-to="0" class="activ
						e"></li>
					...
					<div class="carousel-inner">
						<div class="item active">
							<img src="images/men1.jpg" alt="perfume1"
								style="width: 100%;">
						</div>
				...
				<br>
				<h4
					style="text-align: center; font-family: 'Times New Roman', Times, serif;">men</h4>
					...
					<div class="row text-center">
						<div class="col-sm-4">
							<div class="perfume lower">
								<a href="order.jsp"><img src="images/new_1.jpg" alt="new_1"></a>
								<p>
						...
						<div class="col-sm-4">
							<div class="perfume lower">
								<a href="order.jsp"><img src="images/new_2.jpg" alt="new_2"></a>
								<p>
									<strong>COCO</strong>
								</p>
								<p>Sun. 13 may 2020</p>
								<a href="order.jsp"><button class="btn btn-default">Buy</button></a>
							</div>
						</div>
						<div class="col-sm-4">
							<div class="perfume lower">
								<a href="order.jsp"><img src="images/new_3.jpg" alt="new_3"></a>
								<p>
